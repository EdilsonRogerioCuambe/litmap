    ...
    <div className="min-h-screen bg-[#FAF8F4] flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 selection:bg-[#5c7e6b]/20">
      <div className="sm:mx-auto sm:w-full sm:max-w-md animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <p className="mt-2 text-center text-sm text-[#5c5955]">
          Não tem conta?{" "}
          <Link href="/register" className="font-semibold text-[#5c7e6b] hover:text-[#44664b] transition-colors">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 rounded border-[#e2ddd8] text-[#5c7e6b] focus:ring-[#5c7e6b]"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-[#5c5955]">
                  Lembrar-me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-[#5c7e6b] hover:text-[#44664b]">
                  Esqueceu a senha?
                </a>
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white px-2 text-[#9c9894]">Ou continuar com</span>
              </div>
            </div>
